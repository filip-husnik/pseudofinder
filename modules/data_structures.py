...
class PseudoDesc:
    def __init__(self, description, fully_replaceable=False, fully_irreplaceable=False, sleuth=False, blast=False):
...
class PseudoType:  # Use this class to designate what kind of pseudogene a particular feature is.
    ...
    class Input(Enum):  # Pseudogenes declared in the original genbank file
        general = PseudoDesc(description="Input gbk feature.type is 'pseudo' but we don't have a reason why")
