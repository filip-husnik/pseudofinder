...
# class NestedAttrDict(dict):
#     def __init__(self, *args, **kwargs):
#         super(NestedAttrDict, self).__init__(*args, **kwargs)
#         self.__dict__ = self
#
# class FirstLayerPseudo(NestedAttrDict):
#

#
# test_pseudo = PseudoType.Sleuth.dnds
# print(test_pseudo)
# print(test_pseudo.value)
